...
const Header = () => {
    ...
    return (
        <div className="relative flex flex-col items-center justify-center pt-12 pb-8 px-4">
            {/* Hamburger menu */}
            ...
            {menuOpen && (
                <div className="fixed inset-0 bg-black bg-opacity-60 flex flex-col items-center justify-center z-50">
                    <button
                        className="absolute top-4 right-4 z-50 w-10 h-10 bg-transparent border-none cursor-pointer"
                    ...
                    <nav className="flex flex-col items-center space-y-8">
                        <a href="/ueber-uns" className="text-white text-2xl font-bold hover:text-blue-300">Über uns</a>
                        <a href="/kontakt" className="text-white text-2xl font-bold hover:text-blue-300">Kontakt</a>
                        <a href="/projekte-events" className="text-white text-2xl font-bold hover:text-blue-300">Projekte und Events</a>
                    </nav>
                </div>
            )}
            <a href="/">
